...
time_slice_spacing = 8 # Plot every time_slice_spacing-th slice after start_date (time gap of time_slice_spacing*time_step)
moviefilename = "Movie of 2nd inflated generator eigenvector for the West Block.gif"
...
moviefilename = "Movie of 1st SEBA vector for the West Block.gif"
